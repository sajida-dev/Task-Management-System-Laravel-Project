...
{{-- <h2>Tasks
    <button>
        <a href="{{route('task.createTask')}}">Add new Task</a>
    </button>
</h2>
...
<table>
    ...
    <tr>
        ...
        <td>
            <button>
                <a href="{{route('task.editTask',$val->id)}}">Edit</a>
            </button>
            <button>
                <a href="{{route('task.taskDetails',$val->id)}}">view</a>
            </button>
            <button>
                <a href="{{route('task.delete',$val->id)}}">Delete</a>
            </button>
        </td>
    </tr>
    @endforeach
